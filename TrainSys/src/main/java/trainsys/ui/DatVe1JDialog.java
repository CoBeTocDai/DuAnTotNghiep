 ...
 * @author ADMIN
 */
public class DatVe1JDialog extends javax.swing.JDialog {

    /**
     * Creates new form DatVeJDialog
     */
    public DatVe1JDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DatVe1JDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DatVe1JDialog dialog = new DatVe1JDialog(new javax.swing.JFrame(), true);
